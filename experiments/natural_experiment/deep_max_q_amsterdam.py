...
if __name__ == "__main__":
    g = ig.load(
        Path(f"/home/rico/Documents/thesis/experiments/historical_data_ams/ams_2019/Amsterdam_problem_graph_2019.gml"))
    census_data = gpd.read_parquet(Path(
        f"/home/rico/Documents/thesis/eda/data/Amsterdam/cleaned_neighbourhood_data/kwb_19_ams_neighborhoods.parquet"))
